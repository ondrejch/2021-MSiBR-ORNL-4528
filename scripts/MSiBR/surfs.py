...
def write_surfs(fsf, relba, pitch, slit, temp, r2, rs, rfuel, rcore_inner, rcore_outer, zcore, pht, zrefl, BlanketFraction, tempAug = None):
    ...
    aux_ctrlRod_radius = 1.65
    aux_ctrlRod_sleeve_radius = aux_ctrlRod_radius + 0.05
    ro = aux_ctrlRod_sleeve_radius + 0.1

    center_ctrlRod_radius = 2.05
    center_ctrlRod_sleeve_radius = center_ctrlRod_radius + 0.05
    center_cr = center_ctrlRod_sleeve_radius + 0.5
    ...
    blanketfraction = BlanketFraction
...
surf 304 cyl   0   {ry}   {aux_ctrlRod_radius}	    % OUTER HOLES x 6 CONTROL RODS
surf 305 cyl   0  -{ry}   {aux_ctrlRod_radius}      %           ||
surf 306 cyl   {rox}  {roy}  {aux_ctrlRod_radius}   %           ||
surf 307 cyl  -{rox}  {roy}  {aux_ctrlRod_radius}   %          _||_
surf 308 cyl  -{rox} -{roy}  {aux_ctrlRod_radius}   %          \  /
surf 309 cyl   {rox} -{roy}  {aux_ctrlRod_radius}   % __________\/____________

surf 310 cyl   0   {ry}   {aux_ctrlRod_sleeve_radius}	    % OUTER HOLES x 6 CONTROL RODS Sleeves
surf 311 cyl   0  -{ry}   {aux_ctrlRod_sleeve_radius}      %           ||
surf 312 cyl   {rox}  {roy}  {aux_ctrlRod_sleeve_radius}   %           ||
surf 313 cyl  -{rox}  {roy}  {aux_ctrlRod_sleeve_radius}   %          _||_
surf 314 cyl  -{rox} -{roy}  {aux_ctrlRod_sleeve_radius}   %          \  /
surf 315 cyl   {rox} -{roy}  {aux_ctrlRod_sleeve_radius}   % __________\/____________

surf 316 cyl   0   {ry}   {ro}	    % OUTER HOLES x 6 
surf 317 cyl   0  -{ry}   {ro}      %           ||
surf 318 cyl   {rox}  {roy}  {ro}   %           ||
surf 319 cyl  -{rox}  {roy}  {ro}   %          _||_
surf 320 cyl  -{rox} -{roy}  {ro}   %          \  /
surf 321 cyl   {rox} -{roy}  {ro}   % __________\/____________

surf 330 cyl	0	0	{center_ctrlRod_radius}
surf 331 cyl	0	0	{center_ctrlRod_sleeve_radius}
